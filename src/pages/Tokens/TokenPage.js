    ...
    const columns = [
        ...
        },
        {
            ...
            cell: (row) => {
                return (
                    row.state === 'buy' ?
                        <a href={"https://hashscan.io/mainnet/account/" + row.accountId} target="_blank" style={{color: "#cdffe7"}}>
                            <span className="text-buy link">{row.accountId}</span>
                        </a> :
                        <a href={"https://hashscan.io/mainnet/account/" + row.accountId} target="_blank" style={{color: "#ffacb1"}}>
